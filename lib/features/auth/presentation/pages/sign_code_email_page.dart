...
class SignCodeEmailPage extends StatelessWidget {
  const SignCodeEmailPage({super.key});
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              Text('A code has been sent to \nemail@email.com',style: TextStyle(fontSize: 15.sp),),
              ...
              Center(child: Text('Send another code',style: TextStyle(fontSize: 12.sp,color: primaryColor),)),
              SizedBox(height: 179.h,),
              CustomButtonWidget(title: 'Next',onTap: () {
                NavigationHelper.navigationHelper.navigateToWidget(SignNamePage(),);
              },),
            ],
          ),
        ),
